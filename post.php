...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <a
                href="post.php?category=<?php echo $post_category_id; ?>&p_id=<?php echo $post_id; ?>&user=<?php echo $login_user_id ?>&p_author=<?php echo $post_author ?>"><img
                    class="img-responsive" src="images/<?php echo $post_image ?>" alt=""></a>
            <?php
                } else {
                ?>
            <a
                href="post.php?category=<?php echo $post_category_id; ?>&p_id=<?php echo $post_id; ?>&p_author=<?php echo $post_author ?>"><img
                    class="img-responsive" src="images/<?php echo $post_image ?>" alt=""></a>
            <?php } ?>
            <hr>
